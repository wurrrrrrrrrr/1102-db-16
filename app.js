...
const midterm_16_Router = require('./routes/midterm_16');
const book_16_Router = require('./routes/book_16');
...
app.use('/midterm_16', midterm_16_Router);
app.use('/book_16', book_16_Router);
